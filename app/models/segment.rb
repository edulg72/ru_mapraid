class Segment < ActiveRecord::Base
  ...
  scope :important, -> {where(roadtype: [2,3,4,6,7])}
  ...
  scope :wrong_speed, -> {where('roadtype in (2,3,4,6,7) and ((fwddirection and fwdmaxspeed = 60) or (revdirection and revmaxspeed = 60))')}
